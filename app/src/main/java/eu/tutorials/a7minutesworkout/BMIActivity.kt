...
class BMIActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.btnCalculateUnites?.setOnClickListener{
            calculateUnits()
        }
    }
    ...
    private fun makeVisibleUsUnitsView() {
        ...
        binding?.tilMetricUnitHeightFeet?.visibility = View.VISIBLE // make height feet view visible.
        binding?.tilMetricUnitHeightInch?.visibility = View.VISIBLE // make height inch view visible.

        binding?.etMetricUnitWeight?.text!!.clear() // weight value is cleared.
        binding?.etMetricUnitHeightFeet?.text!!.clear() // height feet value is cleared.
        binding?.etMetricUnitHeightInch?.text!!.clear() // height inch is cleared.
    ...
    private fun displayBMIResult(bmi: Float){
        ...
        if(bmi.compareTo(15f) <= 0){
            ...
            bmiDescription = "Oops! You really need to take better care of yourself! Ear more!"
